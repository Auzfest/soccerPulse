        ...
        <div className="container mx-auto p-6 my-10 text-center">
          <div className="container mx-auto p-6 my-10 bg-slate-200 rounded-md text-center">
            ...
            <p className="text-lg w-1/2 mx-auto">
              Soccer Pulse is an application that allows you to follow your favorite teams and leagues and view their statistics all in one place.
            </p>
          </div>
          <br />
          <div className="container mx-auto p-6 my-10 bg-slate-200 rounded-md text-center">
          ...
          <div className="container mx-auto p-6 my-10 bg-slate-200 rounded-md text-center">
            ...
            <p className="text-lg w-1/2 mx-auto pb-8">
              Register an account to personalize your homepage! Get quick access to recent games and stats of your favorite teams, all in one place.
            </p>
          </div>
          <br />
        </div>
